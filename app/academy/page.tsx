...
export default function Home() {
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col font-sans selection:bg-red-600 selection:text-white">
      ...
      {/* HERO SECTION */}
      <section className="relative pt-16 pb-20 md:pt-28 md:pb-32 overflow-hidden border-b border-zinc-800">
        {/* Halo rouge tamisé de fond */}
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-red-600/10 blur-[160px] rounded-full pointer-events-none -z-10" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
          
          {/* Badge d'accueil */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-zinc-900 border border-zinc-800 text-red-400 text-xs font-semibold mb-8">
            <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
            <span className="text-zinc-300">Brightened Mind Platform</span>
          </div>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center">
            ...
            <Link
              href="/academy/login"
              className="bg-zinc-900 hover:bg-zinc-800 text-white border border-zinc-700 font-bold text-base px-8 py-4 rounded-xl transition flex items-center justify-center"
            >
              Student Login
            </Link>
          </div>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 w-full max-w-4xl">
            <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800/80 text-center">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Level 1 Card */}
          <div className="bg-zinc-900 rounded-2xl p-8 border border-zinc-800 flex flex-col justify-between shadow-md">
            <div>
              <div className="w-12 h-12 rounded-xl bg-zinc-800 border border-zinc-700 text-red-500 flex items-center justify-center font-black text-lg mb-6">
                01
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-zinc-800 flex items-center justify-between text-xs font-semibold text-zinc-400">
          ...
          <div className="bg-zinc-900 rounded-2xl p-8 border border-zinc-800 flex flex-col justify-between shadow-md">
            <div>
              <div className="w-12 h-12 rounded-xl bg-zinc-800 border border-zinc-700 text-white flex items-center justify-center font-black text-lg mb-6">
                02
              </div>
      ...
      {/* SECTION AVANTAGES */}
      <section className="py-20 bg-zinc-900/60 border-y border-zinc-800">
      ...
      {/* FOOTER */}
      <footer className="mt-auto border-t border-zinc-800 bg-zinc-950 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          
          <div className="flex items-center gap-3">
            <div className="relative w-8 h-8 rounded-xl bg-red-600 p-0.5 flex items-center justify-center overflow-hidden">
              <Image
                src="/logo-bm.png"
          ...
          <div className="flex items-center gap-6 text-xs text-zinc-400 font-medium">
            <Link href="/academy/dashboard" className="hover:text-white transition">Dashboard</Link>
            <Link href="/academy/login" className="hover:text-white transition">Login</Link>
          </div>
